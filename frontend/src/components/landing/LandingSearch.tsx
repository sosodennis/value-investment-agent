...
export function LandingSearch({
    ...
    return (
        <div className="relative group">
            ...
            <div className="relative glass-panel rounded-xl flex items-center p-2 focus-within:ring-2 focus-within:ring-primary-container transition-shadow">
                ...
                />
                <button
                    className="bg-primary-container text-on-primary px-6 md:px-8 py-3 rounded-lg font-bold text-xs md:text-sm tracking-wide hover:brightness-110 active:scale-95 transition focus:ring-2 focus:ring-offset-2 focus:ring-primary-container focus:ring-offset-surface disabled:opacity-50"
                    onClick={onAnalyze}
                    disabled={!canAnalyze}
                >
                    Analyze
