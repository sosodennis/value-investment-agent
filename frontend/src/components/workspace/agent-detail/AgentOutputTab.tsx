...
import { FundamentalAnalysisOutput } from '../../agent-outputs/fundamental-analysis/FundamentalAnalysisOutput';
import { NewsResearchOutput as NewsResearchOutputPanel } from '../../agent-outputs/news/NewsResearchOutput';
import { GenericAgentOutput } from '../../agent-outputs/shared/GenericAgentOutput';
import { DebateOutput } from '../../agent-outputs/debate/DebateOutput';
import { TechnicalAnalysisOutput } from '../../agent-outputs/technical-analysis/TechnicalAnalysisOutput';
