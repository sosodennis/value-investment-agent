        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="tech-card p-6 bg-surface-container-low group hover:border-cyan-500/20 hover:bg-surface-container transition-all duration-500">
                    ...
                    <div className="tech-card p-6 bg-surface-container-low group border-rose-500/10 hover:border-rose-500/30 hover:bg-rose-950/5 transition-all duration-500">
                        <div className="flex items-center gap-3 mb-4">
