...
class HistoryService:
    ...
    async def save_messages(
        ...
        async with AsyncSessionLocal() as session:
            ...
            # It's important to expire the instances so that they are refreshed with the latest data from the DB
            # especially for attributes that are auto-generated by the DB like created_at, etc.
            for msg in db_messages:
                await session.expire(msg)
            return db_messages
