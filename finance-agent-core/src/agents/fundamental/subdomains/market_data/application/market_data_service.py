...
from ..domain.consensus_anchor_aggregator import (
    FREE_CONSENSUS_AGGREGATE_SOURCE,
    build_target_consensus_anchor_datums,
)
from ..domain.free_consensus_governance import governance_warning_for_provider
...
class MarketDataService:
    def __init__(
        ...
        *,
        ...
        if not providers:
            raise ValueError("providers must be provided")
