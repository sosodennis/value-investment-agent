"""Internal SEC XBRL extraction models.

These models are extraction-time structures for the sec_xbrl package and
must not be exposed as interface contracts. Canonical payloads live in
financial_statements/interface/contracts.py.
"""
...
class FinancialReport(BaseModel):
    ...
    industry_type: (
        str  # Canonical token: "Industrial" | "FinancialServices" | "RealEstate"
    )
