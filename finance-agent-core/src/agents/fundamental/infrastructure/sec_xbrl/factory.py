...
from .mapping import get_mapping_registry
...
from .report_factory_common_utils import (
    resolve_extension_type as resolve_extension_type_util,
)
from .report_factory_common_utils import (
    resolve_industry_type as resolve_industry_type_util,
)
from .report_factory_common_utils import (
    sum_fields as sum_fields_util,
)
from .resolver import ParsedCandidate
...
class FinancialReportFactory:
    ...
    def create_report(ticker: str, fiscal_year: int | None) -> FinancialReport:
        ...
        # 5. Return Report
        extension_type = resolve_extension_type_util(routing_industry_type)
    ...
    def _resolve_industry_type(sic_code: object) -> str:
        return resolve_industry_type_util(sic_code)

    @staticmethod
    def _sum_fields(
        name: str, fields: list[TraceableField[float]]
    ) -> TraceableField[float]:
        return sum_fields_util(name, fields)
