...
def build_dcf_standard_payload(
    *,
    ...
    params["model_variant"] = "dcf_standard"

    assumptions = list(payload.assumptions)
    assumptions.append("model_variant=dcf_standard routed via dedicated param builder")
