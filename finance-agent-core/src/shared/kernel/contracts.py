...
ARTIFACT_KIND_TA_TIMESERIES_BUNDLE: Final = "ta_timeseries_bundle"
ARTIFACT_KIND_TA_CHART_DATA: Final = "ta_chart_data"
ARTIFACT_KIND_TA_INDICATOR_SERIES: Final = "ta_indicator_series"
ARTIFACT_KIND_TA_ALERTS: Final = "ta_alerts"
ARTIFACT_KIND_TA_FEATURE_PACK: Final = "ta_feature_pack"
ARTIFACT_KIND_TA_PATTERN_PACK: Final = "ta_pattern_pack"
ARTIFACT_KIND_TA_REGIME_PACK: Final = "ta_regime_pack"
ARTIFACT_KIND_TA_FUSION_REPORT: Final = "ta_fusion_report"
ARTIFACT_KIND_TA_VERIFICATION_REPORT: Final = "ta_verification_report"
ARTIFACT_KIND_TA_DIRECTION_SCORECARD: Final = "ta_direction_scorecard"
