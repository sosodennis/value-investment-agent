...
reinvestment_profile_path="${FUNDAMENTAL_REINVESTMENT_CLAMP_PROFILE_PATH:-src/agents/fundamental/subdomains/core_valuation/domain/parameterization/config/reinvestment_clamp_profile.default.json}"
