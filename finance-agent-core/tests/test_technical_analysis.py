...
def test_find_optimal_d_returns_valid_range():
    ...
    from src.agents.technical.subdomains.features.domain import find_optimal_d
...
def test_apply_fracdiff_preserves_structure():
    ...
    from src.agents.technical.subdomains.features.domain import frac_diff_ffd
...
def test_compute_z_score():
    ...
    from src.agents.technical.subdomains.features.domain import compute_z_score
