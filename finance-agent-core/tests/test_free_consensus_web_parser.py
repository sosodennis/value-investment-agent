...
from src.agents.fundamental.infrastructure.market_data.free_consensus_web_parser import (
    ConsensusFetchError,
...
def test_fetch_html_raises_coded_consensus_fetch_error_for_403(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "src.agents.fundamental.infrastructure.market_data.free_consensus_web_parser._http_session",
        lambda: _FakeSession(),
    )
